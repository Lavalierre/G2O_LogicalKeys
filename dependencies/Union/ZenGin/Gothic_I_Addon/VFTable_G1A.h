...
#ifdef __G1A
#ifndef __VFTABLE_STRUCTS_H__VER1__
#define __VFTABLE_STRUCTS_H__VER1__
  ...
  struct vftable_oCViewStatusBar_for_zCViewBase {
    union {
      ...
      group {
        ...
        vfunc f13_SetPreview;        // from oCViewStatusBar  ?SetPreview@oCViewStatusBar@@UAEXM@Z
        vfunc f14_SetValue;          // from oCViewStatusBar  ?SetValue@oCViewStatusBar@@UAEXM@Z
      } names;
    };
  ...
  struct vftable_zCViewStatusBar_for_zCViewBase {
    union {
      ...
      group {
        ...
        vfunc f13_SetPreview;        // from zCViewStatusBar  ?SetPreview@zCViewStatusBar@@UAEXM@Z
        vfunc f14_SetValue;          // from zCViewStatusBar  ?SetValue@zCViewStatusBar@@UAEXM@Z
      } names;
    };
  ...
  struct vftable_oCVisFX_MultiTarget {
    union {
      ...
      group {
        ...
        vfunc f40_SetLevel;                  // from oCVisFX_MultiTarget  ?SetLevel@oCVisFX_MultiTarget@@UAEXH@Z
        vfunc f41_GetLevel;                  // from oCVisualFX           ?GetLevel@oCVisualFX@@UBEHXZ
        ...
        vfunc f56_GetNumCollisionCandidates; // from oCVisualFX           ?GetNumCollisionCandidates@oCVisualFX@@UAEHXZ
        vfunc f57_GetCollidedCandidates;     // from oCVisualFX           ?GetCollidedCandidates@oCVisualFX@@UAEHAAV?$zCArray@PAVzCVob@@@@@Z
        vfunc f58_SetDamage;                 // from oCVisFX_MultiTarget  ?SetDamage@oCVisFX_MultiTarget@@UAEXM@Z
        vfunc f59_SetDamageType;             // from oCVisFX_MultiTarget  ?SetDamageType@oCVisFX_MultiTarget@@UAEXH@Z
        vfunc f60_GetDamage;                 // from oCVisualFX           ?GetDamage@oCVisualFX@@UBEMXZ
        vfunc f61_GetDamageType;             // from oCVisualFX           ?GetDamageType@oCVisualFX@@UBEHXZ
        vfunc f62_IsASpell;                  // from oCVisualFX           ?IsASpell@oCVisualFX@@UAEHXZ
        vfunc f63_SetSpellType;              // from oCVisualFX           ?SetSpellType@oCVisualFX@@UAEXH@Z
  ...
  struct vftable_zCAIPlayer {
    union {
      ...
      group {
        ...
        vfunc f10_HostVobAddedToWorld;             // from zCAIBase    ?HostVobAddedToWorld@zCAIBase@@UAEXPAVzCVob@@PAVzCWorld@@@Z
        vfunc f11_StartStandAni;                   // from zCAIPlayer  ?StartStandAni@zCAIPlayer@@UAEXXZ
        vfunc f12_StartFallDownAni;                // from zCAIPlayer  ?StartFallDownAni@zCAIPlayer@@UAEXXZ
      } names;
    };
  ...
  struct vftable_zCZoneZFogDefault {
    union {
      ...
      group {
        ...
        vfunc f14_GetCharacterClass;       // from zCVob              ?GetCharacterClass@zCVob@@UAE?AW4zTVobCharClass@1@XZ
        vfunc f15_SetSleepingMode;         // from zCVob              ?SetSleepingMode@zCVob@@UAEXW4zTVobSleepingMode@@@Z
        vfunc f16_EndMovement;             // from zCZone             ?EndMovement@zCZone@@UAEXXZ
        vfunc f17_CanThisCollideWith;      // from zCVob              ?CanThisCollideWith@zCVob@@UAEHPAV1@@Z
        vfunc f18_Render;                  // from zCVob              ?Render@zCVob@@UAIHAAUzTRenderContext@@@Z
  ...
  struct vftable_zCVobSoundDaytime {
    union {
      ...
      group {
        ...
        vfunc f14_GetCharacterClass;       // from zCVob              ?GetCharacterClass@zCVob@@UAE?AW4zTVobCharClass@1@XZ
        vfunc f15_SetSleepingMode;         // from zCVob              ?SetSleepingMode@zCVob@@UAEXW4zTVobSleepingMode@@@Z
        vfunc f16_EndMovement;             // from zCVobSound         ?EndMovement@zCVobSound@@UAEXXZ
        vfunc f17_CanThisCollideWith;      // from zCVob              ?CanThisCollideWith@zCVob@@UAEHPAV1@@Z
        vfunc f18_Render;                  // from zCVob              ?Render@zCVob@@UAIHAAUzTRenderContext@@@Z
        vfunc f19_SetVisual;               // from zCZone             ?SetVisual@zCZone@@UAEXABVzSTRING@@@Z
        vfunc f20_SetVisual;               // from zCZone             ?SetVisual@zCZone@@UAEXPAVzCVisual@@@Z
  ...
  struct vftable_oCAIHuman {
    union {
      ...
      group {
        ...
        vfunc f09_HostVobRemovedFromWorld;         // from zCAIPlayer       ?HostVobRemovedFromWorld@zCAIPlayer@@UAEXPAVzCVob@@PAVzCWorld@@@Z
        vfunc f10_HostVobAddedToWorld;             // from zCAIBase         ?HostVobAddedToWorld@zCAIBase@@UAEXPAVzCVob@@PAVzCWorld@@@Z
        vfunc f11_StartStandAni;                   // from oCAniCtrl_Human  ?StartStandAni@oCAniCtrl_Human@@UAEXXZ
        vfunc f12_StartFallDownAni;                // from oCAniCtrl_Human  ?StartFallDownAni@oCAniCtrl_Human@@UAEXXZ
  ...
  struct vftable_oCAIVobMove {
    union {
      ...
      group {
        ...
        vfunc f09_HostVobRemovedFromWorld;         // from zCAIBase     ?HostVobRemovedFromWorld@zCAIBase@@UAEXPAVzCVob@@PAVzCWorld@@@Z
        vfunc f10_HostVobAddedToWorld;             // from zCAIBase     ?HostVobAddedToWorld@zCAIBase@@UAEXPAVzCVob@@PAVzCWorld@@@Z
        vfunc f11_Init;                            // from oCAIVobMove  ?Init@oCAIVobMove@@UAEXPAVzCVob@@0AAVzVEC3@@MMPAVzMAT4@@@Z
      } names;
    };
  ...
  struct vftable_oCAIVobMoveTorch {
    union {
      ...
      group {
        ...
        vfunc f09_HostVobRemovedFromWorld;         // from zCAIBase          ?HostVobRemovedFromWorld@zCAIBase@@UAEXPAVzCVob@@PAVzCWorld@@@Z
        vfunc f10_HostVobAddedToWorld;             // from zCAIBase          ?HostVobAddedToWorld@zCAIBase@@UAEXPAVzCVob@@PAVzCWorld@@@Z
        vfunc f11_Init;                            // from oCAIVobMoveTorch  ?Init@oCAIVobMoveTorch@@UAEXPAVzCVob@@0AAVzVEC3@@MMPAVzMAT4@@@Z
      } names;
    };
  ...
  struct vftable_oCAniCtrl_Human {
    union {
      ...
      group {
        ...
        vfunc f11_StartStandAni;                   // from oCAniCtrl_Human  ?StartStandAni@oCAniCtrl_Human@@UAEXXZ
        vfunc f12_StartFallDownAni;                // from oCAniCtrl_Human  ?StartFallDownAni@oCAniCtrl_Human@@UAEXXZ
        vfunc f13_Init;                            // from oCAniCtrl_Human  ?Init@oCAniCtrl_Human@@UAEXPAVoCNpc@@@Z
      } names;
    };
  ...
  struct vftable_oCItemContainer {
    union {
      ...
      group {
        ...
        vfunc f24_GetTransferCount;               // from oCItemContainer  ?GetTransferCount@oCItemContainer@@UAEFXZ
        vfunc f25_SetTransferCount;               // from oCItemContainer  ?SetTransferCount@oCItemContainer@@UAEXF@Z
        vfunc f26_IncTransferCount;               // from oCItemContainer  ?IncTransferCount@oCItemContainer@@UAEXF@Z
        vfunc f27_Archive;                        // from oCItemContainer  ?Archive@oCItemContainer@@UAEXAAVzCArchiver@@@Z
        vfunc f28_Unarchive;                      // from oCItemContainer  ?Unarchive@oCItemContainer@@UAEXAAVzCArchiver@@@Z
        vfunc f29_Init;                           // from oCItemContainer  ?Init@oCItemContainer@@MAEXHHW4oTItemListMode@1@@Z
        vfunc f30_Init;                           // from oCItemContainer  ?Init@oCItemContainer@@MAEXHH@Z
        vfunc f31_GetPosition;                    // from oCItemContainer  ?GetPosition@oCItemContainer@@MAEXAAH0@Z
        vfunc f32_LoadGrafix;                     // from oCItemContainer  ?LoadGrafix@oCItemContainer@@MAEXXZ
        vfunc f33_DeleteContents;                 // from oCItemContainer  ?DeleteContents@oCItemContainer@@MAEXXZ
        vfunc f34_NextItem;                       // from oCItemContainer  ?NextItem@oCItemContainer@@MAEXXZ
        vfunc f35_PrevItem;                       // from oCItemContainer  ?PrevItem@oCItemContainer@@MAEXXZ
        vfunc f36_CheckSelectedItem;              // from oCItemContainer  ?CheckSelectedItem@oCItemContainer@@MAEXXZ
        vfunc f37_TransferItem;                   // from oCItemContainer  ?TransferItem@oCItemContainer@@MAEHHH@Z
        vfunc f38_SetCategoryOnRightContainer;    // from oCItemContainer  ?SetCategoryOnRightContainer@oCItemContainer@@MAEXXZ
        vfunc f39_Draw;                           // from oCItemContainer  ?Draw@oCItemContainer@@MAEXXZ
        vfunc f40_DrawCategory;                   // from oCItemContainer  ?DrawCategory@oCItemContainer@@MAEXXZ
        vfunc f41_DrawItemInfo;                   // from oCItemContainer  ?DrawItemInfo@oCItemContainer@@MAEXPAVoCItem@@PAVzCWorld@@@Z
      } names;
    };
  ...
  struct vftable_oCStealContainer {
    union {
      ...
      group {
        ...
        vfunc f40_DrawCategory;                   // from oCItemContainer   ?DrawCategory@oCItemContainer@@MAEXXZ
        vfunc f41_DrawItemInfo;                   // from oCItemContainer   ?DrawItemInfo@oCItemContainer@@MAEXPAVoCItem@@PAVzCWorld@@@Z
        vfunc f42_SetOwner;                       // from oCStealContainer  ?SetOwner@oCStealContainer@@UAEXPAVoCNpc@@@Z
        vfunc f43_GetOwner;                       // from oCStealContainer  ?GetOwner@oCStealContainer@@UAEPAVoCNpc@@XZ
        vfunc f44_CreateList;                     // from oCStealContainer  ?CreateList@oCStealContainer@@UAEXXZ
      } names;
    };
  ...
  struct vftable_oCNpcContainer {
    union {
      ...
      group {
        ...
        vfunc f42_SetOwner;                       // from oCStealContainer  ?SetOwner@oCStealContainer@@UAEXPAVoCNpc@@@Z
        vfunc f43_GetOwner;                       // from oCStealContainer  ?GetOwner@oCStealContainer@@UAEPAVoCNpc@@XZ
        vfunc f44_CreateList;                     // from oCNpcContainer    ?CreateList@oCNpcContainer@@UAEXXZ
      } names;
    };
  ...
  struct vftable_oCNpcInventory {
    union {
      ...
      group {
        ...
        vfunc f25_SetTransferCount;               // from oCItemContainer  ?SetTransferCount@oCItemContainer@@UAEXF@Z
        vfunc f26_IncTransferCount;               // from oCItemContainer  ?IncTransferCount@oCItemContainer@@UAEXF@Z
        vfunc f27_Archive;                        // from oCNpcInventory   ?Archive@oCNpcInventory@@UAEXAAVzCArchiver@@@Z
        vfunc f28_Unarchive;                      // from oCNpcInventory   ?Unarchive@oCNpcInventory@@UAEXAAVzCArchiver@@@Z
        vfunc f29_Init;                           // from oCItemContainer  ?Init@oCItemContainer@@MAEXHHW4oTItemListMode@1@@Z
        vfunc f30_Init;                           // from oCItemContainer  ?Init@oCItemContainer@@MAEXHH@Z
        vfunc f31_GetPosition;                    // from oCItemContainer  ?GetPosition@oCItemContainer@@MAEXAAH0@Z
        vfunc f32_LoadGrafix;                     // from oCItemContainer  ?LoadGrafix@oCItemContainer@@MAEXXZ
        ...
        vfunc f37_TransferItem;                   // from oCItemContainer  ?TransferItem@oCItemContainer@@MAEHHH@Z
        vfunc f38_SetCategoryOnRightContainer;    // from oCItemContainer  ?SetCategoryOnRightContainer@oCItemContainer@@MAEXXZ
        vfunc f39_Draw;                           // from oCNpcInventory   ?Draw@oCNpcInventory@@MAEXXZ
        vfunc f40_DrawCategory;                   // from oCNpcInventory   ?DrawCategory@oCNpcInventory@@MAEXXZ
        vfunc f41_DrawItemInfo;                   // from oCItemContainer  ?DrawItemInfo@oCItemContainer@@MAEXPAVoCItem@@PAVzCWorld@@@Z
        vfunc f42_Remove;                         // from oCNpcInventory   ?Remove@oCNpcInventory@@UAEPAVoCItem@@ABVzSTRING@@H@Z
        vfunc f43_Remove;                         // from oCNpcInventory   ?Remove@oCNpcInventory@@UAEPAVoCItem@@HH@Z
        vfunc f44_IsIn;                           // from oCNpcInventory   ?IsIn@oCNpcInventory@@UAEPAVoCItem@@ABVzSTRING@@H@Z
        vfunc f45_IsIn;                           // from oCNpcInventory   ?IsIn@oCNpcInventory@@UAEPAVoCItem@@HH@Z
        vfunc f46_IsIn;                           // from oCNpcInventory   ?IsIn@oCNpcInventory@@UAEPAVoCItem@@PAV2@H@Z
        vfunc f47_IsEmpty;                        // from oCNpcInventory   ?IsEmpty@oCNpcInventory@@UAEHH@Z
      } names;
    };
  ...
  struct vftable_oCMobBed {
    union {
      ...
      group {
        ...
        vfunc f63_StartStateChange;         // from oCMobInter  ?StartStateChange@oCMobInter@@MAEXPAVoCNpc@@HH@Z
        vfunc f64_CheckStateChange;         // from oCMobInter  ?CheckStateChange@oCMobInter@@MAEXPAVoCNpc@@@Z
        vfunc f65_CanChangeState;           // from oCMobInter  ?CanChangeState@oCMobInter@@MAEHPAVoCNpc@@HH@Z
        vfunc f66_GetTransitionNames;       // from oCMobInter  ?GetTransitionNames@oCMobInter@@MAEXHHAAVzSTRING@@0@Z
        ...
        vfunc f69_CallOnStateFunc;          // from oCMobInter  ?CallOnStateFunc@oCMobInter@@MAEXPAVoCNpc@@H@Z
        vfunc f70_SendCallOnStateFunc;      // from oCMobInter  ?SendCallOnStateFunc@oCMobInter@@MAEXPAVoCNpc@@H@Z
  ...
  struct vftable_oCMobSwitch {
    union {
      ...
      group {
        ...
        vfunc f65_CanChangeState;           // from oCMobInter   ?CanChangeState@oCMobInter@@MAEHPAVoCNpc@@HH@Z
        vfunc f66_GetTransitionNames;       // from oCMobInter   ?GetTransitionNames@oCMobInter@@MAEXHHAAVzSTRING@@0@Z
        vfunc f67_OnBeginStateChange;       // from oCMobInter   ?OnBeginStateChange@oCMobInter@@MAEXPAVoCNpc@@HH@Z
        vfunc f68_OnEndStateChange;         // from oCMobInter   ?OnEndStateChange@oCMobInter@@MAEXPAVoCNpc@@HH@Z
        vfunc f69_CallOnStateFunc;          // from oCMobInter   ?CallOnStateFunc@oCMobInter@@MAEXPAVoCNpc@@H@Z
        vfunc f70_SendCallOnStateFunc;      // from oCMobInter   ?SendCallOnStateFunc@oCMobInter@@MAEXPAVoCNpc@@H@Z
        vfunc f71_SearchFreePosition;       // from oCMobInter   ?SearchFreePosition@oCMobInter@@MAEPAUTMobOptPos@@PAVoCNpc@@M@Z
      } names;
    };
...
#undef MemUnlock
#endif // __VFTABLE_STRUCTS_H__VER1__
#endif // __G1A